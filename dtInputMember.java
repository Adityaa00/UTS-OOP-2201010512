...
public class dtInputMember {
    ...
    //Overloading InputData dengan parameter String memberId
    public void InputData(String memberId) {
        int idx = aRec;
        ...
        System.out.println("Tambah Member Gym dengan ID " + memberId);
        System.out.println("~~~~~~~~~~~~~~~~~~");
        System.out.print("Nama Member : ");
        dtProduk[idx][0] = dtIN.nextLine();
    ...
    //Overloading UpdateData dengan parameter int memberId
    public void UpdateData(int memberId) {
        System.out.println("Ubah Data Member Gym dengan ID " + memberId);
        System.out.println("~~~~~~~~~~~~~~~~~~~~~");
        System.out.print("Nomor Record: ");
        ...
        System.out.println("Jenis Kelamin: " + dtProduk[idx][2]);
        System.out.print("Diubah menjadi: ");
        dtProduk[idx][22] = "Diubah menjadi: ";
        dtProduk[idx][2] = dtIN.nextLine();
    ...
    public void DestroyData() {
        ...
        for (int i = 0; i < aRec; i++) {
            ...
            tmp[cidx][3] = dtProduk[i][3];
            tmp[cidx][4] = dtProduk[i][4];
            cidx++;
        }
        aRec--;
        for (int i = 0; i < aRec; i++) {
    ...
    //Overloading DestroyData dengan parameter String memberId
    public void DestroyData(String memberId) {
        String[][] tmp = new String[jRecord][5];

        System.out.println("Hapus Member Gym dengan ID " + memberId);
        System.out.println("~~~~~~~~~~~~~~~~~");
        System.out.println("No Record: ");

        int idx = Integer.parseInt(memberId);
        System.out.println("Data yang dihapus");
        System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~");
        System.out.println("Nama member: " + dtProduk[idx][0]);
        System.out.println("Jenis Member: " + dtProduk[idx][1]);
    ...
    //Overloading viewData dengan parameter boolean showDeleted
    public void viewData(boolean showDeleted) {
        System.out.println("Data Member Gym (" + aRec + "/" + jRecord + ")");
        System.out.println("~~~~~~~~~~~~~~~~");
        for (int i = 0; i < aRec; i++) {
            System.out.println("Data Record ke" + i);
            ...
            System.out.println("Tanggal Habis Member :" + dtProduk[i][4]);
            if (showDeleted) {
                System.out.println("Data ini telah dihapus");
            }
        }
        System.out.println("");
    }
